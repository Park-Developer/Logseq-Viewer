...
from LogView_Lib import viewer_config
...
def set_js(doc_addr):
    ...
    /* [Global Variable]  */
    var PRIORITY_FILTER_VALUE = "-- ALL --" // default
    var ASSIGNEE_FILTER_VALUE = "-- ALL --" // default
    ...
    task_combo_box = document.querySelector('select[name="task_combo"]');
    assignee_combo_box =  document.querySelector('select[name="assignee_combo"]');

    schedule_pri_All_btn = document.querySelector(".schedule_pri_All_btn");
    schedule_pri_A_btn = document.querySelector(".schedule_pri_A_btn");
    schedule_pri_B_btn = document.querySelector(".schedule_pri_B_btn");
    schedule_pri_C_btn = document.querySelector(".schedule_pri_C_btn");
    schedule_pri_X_btn = document.querySelector(".schedule_pri_X_btn");

    dead_pri_all_btn = document.querySelector(".dead_pri_All_btn");
    dead_pri_A_btn = document.querySelector(".dead_pri_A_btn");
    dead_pri_B_btn = document.querySelector(".dead_pri_B_btn");
    dead_pri_C_btn = document.querySelector(".dead_pri_C_btn");
    dead_pri_X_btn = document.querySelector(".dead_pri_X_btn");

    /* [Function Definition] */

    // Combo Box Filtering1
    function task_combo_filtering(e){
        reset_btn_click(); // reset flitering

        assignee_combo_box.value = "-- ALL --";
        schedule_pri_All_btn.classList.add("btn_active");
        ...
        if (selected_task=="-- ALL --"){
            ...
            selected_tr_cls= selected_task + '_';
    ...
    function assignee_combo_filtering(e){
        const selected_assignee = e.value;
        ASSIGNEE_FILTER_VALUE = selected_assignee;
        reset_btn_click();

      
        // reset other filtering
        task_combo_box.value = "-- ALL --";
        schedule_pri_All_btn.classList.add("btn_active");

       
            selected_tr_cls='Assignee_' + selected_assignee;
            ...
            for (var row_line = 1; row_line < schedule_table__row_num; row_line++) {
                if(schedule_table.rows[row_line].cells[0].classList.contains("MainID")){
                    ...
                    for(var i=0; i<sub_tsk_num;i++){
                        if(schedule_table.rows[task_idx+i].classList.contains(selected_tr_cls)){
                            assignee_list.push(task_idx+i);                    
                        }else{
                    ...
                    // Name Reset 
                    if(name_reset_flag==true && assignee_list.length!=0){
                        new_cell_idx=assignee_list[0];
                    
                        // Add Main Taskname
                        var new_cell = schedule_table.rows[new_cell_idx].insertCell(0);
                        new_cell.innerHTML=main_tsk_name;
                        new_cell.classList.add("MainID");
                    ...
                    if(assignee_list.length!=0){
                        ...
                        schedule_table.rows[assignee_list[0]].cells[0].rowSpan=assignee_list.length;
                    }
                }
            }
    ...
    function Priority_btn_click(selected_Priority){
        ...
        PRIORITY_FILTER_VALUE = selected_Priority;
    ...
    function Pri_A_btn_click(){
        ...
        if (schedule_pri_All_btn.classList.contains('btn_active')){
          schedule_pri_All_btn.classList.remove("btn_active");
        }

        schedule_pri_A_btn.classList.add("btn_active");
    ...
    function Pri_B_btn_click(){
        ...
        schedule_pri_B_btn.classList.add("btn_active");
    ...
    function Pri_C_btn_click(){
        ...
        schedule_pri_C_btn.classList.add("btn_active");
    ...
    function Pri_X_btn_click(){
        ...
        schedule_pri_X_btn.classList.add("btn_active");
    ...
    function reset_btn_click() {
        ...
        if (schedule_pri_A_btn.classList.contains('btn_active')){
          schedule_pri_A_btn.classList.remove("btn_active");
        }

        if (schedule_pri_B_btn.classList.contains('btn_active')){
          schedule_pri_B_btn.classList.remove("btn_active");
        }

        if (schedule_pri_C_btn.classList.contains('btn_active')){
          schedule_pri_C_btn.classList.remove("btn_active");
        }

        if (schedule_pri_X_btn.classList.contains('btn_active')){
          schedule_pri_X_btn.classList.remove("btn_active");
        }
    ...
    todo_dead_func="""
        ...
        // Button Style Reset
        dead_pri_all_btn.classList.add("btn_active");

        if (dead_pri_A_btn.classList.contains('btn_active')){
            dead_pri_A_btn.classList.remove("btn_active");
        }

        if (dead_pri_B_btn.classList.contains('btn_active')){
            dead_pri_B_btn.classList.remove("btn_active");
        }
        
        if (dead_pri_C_btn.classList.contains('btn_active')){
            dead_pri_C_btn.classList.remove("btn_active");
        }

        if (dead_pri_X_btn.classList.contains('btn_active')){
            dead_pri_X_btn.classList.remove("btn_active");
        }
        ...
        function todo_Pri_A_btn_click(){
            ...
            dead_pri_A_btn.classList.add("btn_active");
        ...
        function todo_Pri_B_btn_click(){
            ...
            dead_pri_B_btn.classList.add("btn_active");
        ...
        function todo_Pri_C_btn_click(){
            ...
            dead_pri_C_btn.classList.add("btn_active");
        ...
        function todo_Pri_X_btn_click(){
            ...
            dead_pri_X_btn.classList.add("btn_active");
